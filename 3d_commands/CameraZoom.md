...
PositionEntity camel,0,1,1000; Set initial zoom value
...
If KeyDown( 203 )=True Then TurnEntity camera,0,1,0; Change zoom value depending on key pressed

If KeyDown( 208 )=True Then zoom#=zoom#-0.1

If KeyDown( 200 )=True Then zoom#=zoom#+0.1; Put a minimum and maximum cap on zoom value

If zoom#<1 Then zoom#=1

If zoom#>100 Then zoom#=100; Set camera zoom
