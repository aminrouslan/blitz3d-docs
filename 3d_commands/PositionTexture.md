...
tex=LoadTexture( "media/b3dlogo.jpg" ); Texture cube

EntityTexture cube,tex; Set initial uv position values

u_position#=1

v_position#=1

While Not KeyDown( 1 ); Change uv position values depending on key pressed
...
If KeyDown( 205 )=True Then v_position#=v_position#+0.01 ; Position texture
