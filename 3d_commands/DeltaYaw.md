...
camera=CreateCamera(); Make camera orthagraphic for flat, 2D view

CameraProjMode camera,2; Position and rotate camera so we have overhead (top-down) view

PositionEntity camera,0,5,0

RotateEntity camera,90,0,0; Create red cone (the arrow)
...
EntityColor arrow,255,0,0; Create blue sphere (the spot)
...
While Not KeyDown(1); If w,a,s,d pressed then move spot
	...
	If KeyDown(32)=True Then MoveEntity spot,0.01,0,0 ; d - right; Rotate arrow using delta yaw value. Arrow will point at spot.
