...
See also: CreateTexture, LoadTexture, SetCubeFace.
...
EntityTexture teapot,tex; Set initial cube mode value
...
While Not KeyDown(1); Control camera; mouse look
	...
	If KeyDown(203)=True Then MoveEntity cam,-.2,0,0 ; move camera right; If M key pressed then change cube mode
	...
	EndIf; Turn ufo pivot, causing child ufo mesh to spin around it (and teapot)
