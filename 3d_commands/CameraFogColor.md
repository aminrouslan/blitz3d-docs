...
CameraFogMode camera,1; Set camera fog range

CameraFogRange camera,1,10; Set initial fog colour values
...
If KeyDown( 7 )=True And blue#<255 Then blue#=blue#+1; Set camera fog color using red, green, blue values
