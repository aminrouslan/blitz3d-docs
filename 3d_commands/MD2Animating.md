...
While Not KeyDown( 1 ); Toggle animation stop/start when spacebar pressed
...
Text 0,0,"Press spacebar to stop/start md2 animation"; Output current md2 animation status to screen
