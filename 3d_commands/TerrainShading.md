...
RotateEntity light,45,0,0; Load terrain
...
While Not KeyDown( 1 ); Toggle terrain shading value between 0 and 1 when spacebar is pressed

If KeyHit(57)=True Then terra_shade=1-terra_shade; Enable/disable terrain shading
