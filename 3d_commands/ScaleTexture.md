...
EntityTexture cube,tex; Set initial uv scale values

u_scale#=1

v_scale#=1

While Not KeyDown( 1 ); Change uv scale values depending on key pressed
...
If KeyDown( 205 )=True Then v_scale#=v_scale#+0.01 ; Scale texture
