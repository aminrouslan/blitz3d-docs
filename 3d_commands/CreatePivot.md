...
RotateEntity light,90,0,0; Create pivot. This is invisible.

pivot=CreatePivot(); Create planet (i.e. a sphere). Make the pivot the parent of the planet.

planet=CreateSphere(16,pivot); Position planet so that it is offset from the pivot

PositionEntity planet,5,0,0

While Not KeyDown(1); Turn pivot, thus making planet spin around it
