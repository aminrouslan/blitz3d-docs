...
EntityTexture terrain,grass_tex,0,1; Set terrain detail, enable vertex morphing
...
Text 0,0,"Use cursor keys to move about the terrain"; Output TerrainX value to screen
