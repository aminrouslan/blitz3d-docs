...
ScaleEntity terra,x_scale,y_scale,z_scale; Texture terrain

grass_tex=LoadTexture("media/mossyground.bmp")

EntityTexture terra,grass_tex; Create marker
...
While Not KeyDown(1); Change marker position values depending on cursor key pressed
...
If KeyHit(200)=True Then marker_z=marker_z+1; Get terrain height at marker position

marker_y#=TerrainHeight(terra,marker_x,marker_z); If A pressed then increase marker_y value and modify terrain
...
EndIf; If Z pressed then decrease marker_y value and modify terrain
...
EndIf; Position marker, taking into account x, y and z scales of terrain
