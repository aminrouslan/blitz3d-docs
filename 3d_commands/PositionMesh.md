...
See also: PositionEntity, MoveEntity, TranslateEntity.
...
While Not KeyDown(1); If space bar pressed then position mesh 1 unit along the z axis. Also set syntax$ text.
