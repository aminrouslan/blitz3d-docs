...
Graphics3D 640,480 ; This bit of code creates 4 textures ; of different sizes and shapes.
...
texture4=CreateTexture(200,200,59); The following lines print the selected value; of the texture, and reports the actual texture; resolution.
