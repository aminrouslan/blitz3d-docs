...
EntityPitch
 to get the pitch value of an entity that is pointing in the vector's direction.
...
PositionEntity pivot,vx#,vy#,vz#; Point cone in direction of pivot. It should now have same pitch value.

PointEntity cone,pivot

While Not KeyDown(1)

	RenderWorld; Print entity pitch value and vector pitch value. Both should be identical.
