...
```blitzbasic
; DebugLog Example; Let's start graphics mode

Graphics 640,480,16; Now, let's load an image that doesn't exist!
...
End If; This is supposed to generate an error. Press F9 to see the log!
