...
```blitzbasic
; HidePointer / ShoPointer Example; draw a simple screen, cut in half by a white line
...
Text 600,300,"HidePointer",True,True; and a simple loop in which we hide / show the pointer dependent on ; which side of the screen the mouse is on!
