...
See also: LockedPitch, LockedFormat, LockedPixels, ReadPixelFast, WritePixelFast, UnlockBuffer.
...
Graphics 640,480,16; Draw a bunch of stuff on the screen
...
Delay 3000; Copy the top half of the screen over the bottom half; using fast pixels and locked buffers
...
Delay 3000; Draw the left half of the screen over the right half; using the slower direct pixel access
